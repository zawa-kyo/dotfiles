...
file_link "$DOTFILES_ROOT/config/tools/mise/config.global.toml" "$HOME/.config/mise/mise.toml" all
file_link "$DOTFILES_ROOT/config/tools/mise/config.global.lock" "$HOME/.config/mise/mise.lock" all

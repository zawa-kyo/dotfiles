  ...
  config = function()
    ...
    dashboard.section.buttons.val = {
      ...
      dashboard.button(
        "W",
        "󰱼  Find Texts",
        ":lua require('snacks').picker.grep(require('config.snacks-toggles').opts())<CR>"
      ),
      dashboard.button(
        "f",
        "󰥨  Find Files",
        ":lua require('snacks').picker.files(require('config.snacks-toggles').opts())<CR>"
      ),
      dashboard.button("F", "  Show Recent Files", ":lua require('snacks').picker.recent()<CR>"),
      dashboard.button(
        "e",
        "󰉖  Snacks Explorer",
        ":lua require('snacks').explorer.open(require('config.snacks-toggles').opts())<CR>"
      ),

...
keymap("n", "<leader>gwh", "<C-w>h", opts("Go to left window"))
keymap("n", "<leader>gwj", "<C-w>j", opts("Go to bottom window"))
keymap("n", "<leader>gwk", "<C-w>k", opts("Go to top window"))
keymap("n", "<leader>gwl", "<C-w>l", opts("Go to right window"))
...
-- Close editor containers (<leader>c…)
keymap("n", "<leader>cw", "<Cmd>close<CR>", opts("Close the current window"))
keymap("n", "<leader>cW", "<Cmd>only<CR>", opts("Close other windows"))
keymap("n", "<leader>ct", "<Cmd>tabclose<CR>", opts("Close the current tab page"))
